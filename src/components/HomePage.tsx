  ...
  return (
    <div className="min-h-screen bg-[#020817]">
      ...
      <section className="relative min-h-screen w-full flex items-center">
        ...
        <div className="section-container relative z-10 py-16 md:py-0">
          <div className="grid lg:grid-cols-2 gap-8 md:gap-12 items-center">
            ...
            >
              <motion.div className="space-y-4">
                <motion.h1 
                  className="text-4xl sm:text-5xl md:text-[clamp(2.5rem,6vw,5rem)] font-bold leading-[1.1] tracking-tight"
                >
                  <motion.span
                    variants={item}
              ...
              >
                <Link
                  to="/contact"
                  className="group relative overflow-hidden rounded-full bg-gradient-to-r from-blue-500 to-purple-600 p-[2px] w-full sm:w-auto"
                >
                  <div className="relative bg-[#020817] rounded-full px-6 sm:px-8 py-3 sm:py-4 transition-all duration-300 group-hover:bg-transparent text-center sm:text-left">
                    <span className="relative flex items-center justify-center text-white text-base sm:text-lg font-medium">
                      Get Started
                ...
                <Link
                  to="/tech-solutions"
                  className="group relative overflow-hidden rounded-full border border-blue-500/30 px-6 sm:px-8 py-3 sm:py-4 transition-all duration-300 hover:border-blue-500/50 hover:bg-blue-500/10 w-full sm:w-auto text-center sm:text-left"
                >
            ...
            {/* Image Carousel - Hidden on mobile, visible on lg screens */}
            <motion.div
              initial={{ opacity: 0, x: 50 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ duration: 0.8 }}
              className="relative h-[300px] md:h-[400px] lg:h-[500px] xl:h-[600px] hidden md:block mt-8 lg:mt-0"
            >
              ...
              {/* Decorative Elements */}
              <div className="absolute -top-8 -right-8 w-32 h-32 sm:w-48 sm:h-48 lg:w-64 lg:h-64 bg-blue-500/30 rounded-full blur-3xl animate-pulse"></div>
              <div className="absolute -bottom-8 -left-8 w-32 h-32 sm:w-48 sm:h-48 lg:w-64 lg:h-64 bg-purple-500/30 rounded-full blur-3xl animate-pulse delay-1000"></div>
            </motion.div>
          </div>
        </div>
      </section>
      ...
      {/* What We Provide */}
      <section className="w-full py-12 sm:py-16 md:py-20 bg-[#020817] relative overflow-hidden">
        <div className="section-container relative z-10">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-blue-500 mb-8 sm:mb-12 md:mb-16">WHAT WE PROVIDE</h2>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
            {[
              ...
              <div 
                key={index} 
                className="service-card bg-[#1E0B33] rounded-3xl p-4 sm:p-6 transform hover:-translate-y-2 transition-all duration-500"
              >
                <div className="flex flex-col h-full">
                  <div className="relative h-36 sm:h-40 md:h-48 rounded-xl sm:rounded-2xl overflow-hidden mb-4 sm:mb-6">
                    <img 
                      src={service.image}
                      alt={service.title}
                  ...
                  <div className="mb-2 sm:mb-4">
                    <h3 className={`text-lg sm:text-xl text-${service.color}-400 font-semibold`}>{service.title}</h3>
                  </div>
      ...
      <section className="w-full py-12 sm:py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="section-container relative z-10">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-500 mb-2 sm:mb-4 fade-up">WHO ARE WE</h2>
            <h3 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold bg-gradient-to-r from-blue-500 to-purple-500 bg-clip-text text-transparent fade-up leading-tight max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            {[
              ...
              <div key={index} className="stat-card fade-up" style={{transitionDelay: `${index * 0.1}s`}}>
                <div className="bg-[#0a1225]/90 backdrop-blur-lg rounded-lg sm:rounded-2xl p-4 sm:p-6 border border-blue-500/20 hover:border-blue-500/40 transition-all duration-300 text-center">
      ...
      {/* Our Resources */}
      <section className="w-full py-12 sm:py-16 md:py-20 bg-[#0a1225]">
        <div className="section-container">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-center text-blue-500 mb-8 sm:mb-12 md:mb-16">OUR RESOURCES</h2>
            ...
            {[
              ...
              <div key={i} className="resource-card fade-up group" style={{transitionDelay: `${i * 0.1}s`}}>
                ...
                <div className="p-4 sm:p-6">
                  <h3 className="text-base sm:text-lg font-bold text-blue-400 mb-1 sm:mb-2">{item.title}</h3>
      ...
      <section className="w-full py-12 sm:py-16 md:py-20 bg-[#020817] relative overflow-hidden">
        ...
        <div className="section-container relative z-10">
          <div className="text-center mb-8 sm:mb-12 md:mb-16">
            <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-500 mb-2 sm:mb-4">Technology Partnerships</h2>
            <p className="text-base sm:text-lg md:text-xl text-gray-400">Powered by industry leaders in technology</p>
          </div>
                ...
                <div key={`track-${trackIndex}`} className="partners-track">
                  {[...Array(3)].map((_, groupIndex) => (
                    <React.Fragment key={`group-${trackIndex}-${groupIndex}`}>
                      <div className="flex justify-center items-center p-4 sm:p-6 md:p-8 bg-[#0a1225]/50 rounded-lg sm:rounded-xl">
                        <img 
                          src="https://upload.wikimedia.org/wikipedia/commons/9/96/Microsoft_logo_%282012%29.svg"
                          alt="Microsoft"
                          className="partner-logo h-6 sm:h-8 md:h-10 lg:h-12"
                        />
                      </div>
                      <div className="flex justify-center items-center p-4 sm:p-6 md:p-8 bg-[#0a1225]/50 rounded-lg sm:rounded-xl">
                        <img 
